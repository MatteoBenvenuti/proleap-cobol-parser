...
public class ConditionGreaterOrEqualTest extends CobolTestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/asg/valuestmt/relation/ConditionGreaterOrEqual.cbl");
		final Program program = new CobolParserRunnerImpl().analyzeFile(inputFile, CobolSourceFormatEnum.TANDEM);

		final CompilationUnit compilationUnit = program.getCompilationUnit("ConditionGreaterOrEqual");
...

						{
...

							{
...

								{
									...
									assertEquals(RelationalOperator.RelationalOperatorType.GREATER_OR_EQUAL,
