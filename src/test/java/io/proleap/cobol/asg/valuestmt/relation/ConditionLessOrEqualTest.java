...
public class ConditionLessOrEqualTest extends CobolTestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/asg/valuestmt/relation/ConditionLessOrEqual.cbl");
		final Program program = new CobolParserRunnerImpl().analyzeFile(inputFile, CobolSourceFormatEnum.TANDEM);

		final CompilationUnit compilationUnit = program.getCompilationUnit("ConditionLessOrEqual");
...

						{
...

							{
...

								{
									...
									assertEquals(RelationalOperator.RelationalOperatorType.LESS_OR_EQUAL,
