...
public class ConditionOrTest extends CobolTestBase {
	...
	public void test() throws Exception {
		final File inputFile = new File("src/test/resources/io/proleap/cobol/asg/valuestmt/relation/ConditionOr.cbl");
...

		{
...

			{
...

				{
					...
					assertEquals(AndOrConditionType.OR, andOrCondition.getAndOrConditionType());
